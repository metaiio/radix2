return {
    ...
    ['Alchemy'] = {
        -- Skill-up recipes (in order)
        {
            Recipe='Potion of Accuracy',
            Trivial=83,
            Materials={'Birthwort','Blue Vervain Bulb','Fenugreek'},
            Container='Medicine Bag',
        },
        {
            Recipe='Greater Potion of Accuracy',
            Trivial=150,
            Materials={'Birthwort','Fenugreek','Valerian Root'},
            Container='Medicine Bag',
        },
        {
        ...
        -- Useful potions (Distillates)
        {
            Recipe='Distillate of Alacrity IV',
            Trivial=88,
            Materials={'Small Vial','Small Vial','Small Vial','Small Vial','Small Vial','Arnworth','Snakes Head Iris','White Hellebore'},
            Container='Medicine Bag',
        },
        {
            Recipe='Distillate of Clarity VII',
            Trivial=202,
            Materials={'Small Vial','Small Vial','Small Vial','Small Vial','Small Vial','Katuka Bark','Autumn Crocus','Bistort'},
            Container='Medicine Bag',
        },
        {
            Recipe='Distillate of Health VII',
            Trivial=202,
            Materials={'Small Vial','Small Vial','Small Vial','Small Vial','Small Vial','Cententialspore','Autumn Crocus','Bistort'},
            Container='Medicine Bag',
        },
        {
            Recipe='Distillate of Divine Healing VIII',
            Trivial=255,
            Materials={'Small Vial','Small Vial','Small Vial','Small Vial','Small Vial','Tregrum','Red Cups','Stinging Nettle'},
            Container='Medicine Bag',
        },
        {
            Recipe='Distillate of Divine Healing X',
            Trivial=348,
            Materials={'Small Vial','Small Vial','Small Vial','Small Vial','Small Vial','Nodding Blue Lily','Hemlock Powder','Tregrum'},
            Container='Medicine Bag',
        },
        {
            Recipe='Distillate of Alacrity X',
            Trivial=348,
            Materials={'Small Vial','Small Vial','Small Vial','Small Vial','Small Vial','Nodding Blue Lily','Hemlock Powder','Arnworth'},
            Container='Medicine Bag',
        },
        {
            Recipe='Distillate of Clarity X',
            Trivial=348,
            Materials={'Small Vial','Small Vial','Small Vial','Small Vial','Small Vial','Nodding Blue Lily','Hemlock Powder','Katuka Bark'},
            Container='Medicine Bag',
        },
        {
            Recipe='Distillate of Health X',
            Trivial=348,
            Materials={'Small Vial','Small Vial','Small Vial','Small Vial','Small Vial','Nodding Blue Lily','Hemlock Powder','Cententialspore'},
            Container='Medicine Bag',
        },
    },
    ['Poison Making'] = {
        -- Skill-up recipes (in order) - Rogue only tradeskill
        {
            Recipe='Quicksilver',
            Trivial=15,
            Materials={'Cinnabar','Gnomish Spirits'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Atrophic Sap',
            Trivial=98,
            Materials={'Lined Poison Vial','Constrict Suspension','Alocasia Root','Alocasia Root'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Calcium Rot',
            Trivial=172,
            Materials={'Sealed Poison Vial','Constrict Suspension','King\'s Thorn','King\'s Thorn'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Spirit of Sloth',
            Trivial=275,
            Materials={'Sealed Poison Vial','Ethereal Suspension','Creeper Ivy','Creeper Ivy'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Mind Melt',
            Trivial=300,
            Materials={'Sealed Poison Vial','Ethereal Suspension','Quicksilver','Mt. Death Mineral Salts','Mt. Death Mineral Salts'},
            Container='Mortar and Pestle',
        },
        -- Useful ALL/ALL poisons (Spider's Bite series)
        {
            Recipe='Spider\'s Bite I',
            Trivial=55,
            Materials={'Primitive Poison Vial','Thick Suspension Fluid','Emulsifier','Weak Nigriventer Venom'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Spider\'s Bite III',
            Trivial=112,
            Materials={'Rough Poison Vial','Thick Suspension Fluid','Emulsifier','Grade D Nigriventer Venom'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Spider\'s Bite V',
            Trivial=168,
            Materials={'Plain Poison Vial','Thick Suspension Fluid','Emulsifier','Grade C Nigriventer Venom'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Spider\'s Bite VII',
            Trivial=224,
            Materials={'Simple Poison Vial','Thick Suspension Fluid','Emulsifier','Grade B Nigriventer Venom'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Spider\'s Bite IX',
            Trivial=280,
            Materials={'Smooth Poison Vial','Thick Suspension Fluid','Emulsifier','Grade A Nigriventer Venom'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Spider\'s Bite XI',
            Trivial=324,
            Materials={'Etched Poison Vial','Thick Suspension Fluid','Refined Grade A Nigriventer Venom'},
            Container='Mortar and Pestle',
        },
        -- Scorpion's Agony series (ALL/ALL)
        {
            Recipe='Scorpion\'s Agony I',
            Trivial=55,
            Materials={'Primitive Poison Vial','Thick Suspension Fluid','Emulsifier','Weak Scorpion Venom'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Scorpion\'s Agony V',
            Trivial=168,
            Materials={'Plain Poison Vial','Thick Suspension Fluid','Emulsifier','Grade C Scorpion Venom'},
            Container='Mortar and Pestle',
        },
        {
            Recipe='Scorpion\'s Agony IX',
            Trivial=280,
            Materials={'Smooth Poison Vial','Thick Suspension Fluid','Emulsifier','Grade A Scorpion Venom'},
            Container='Mortar and Pestle',
        },
    },
    ['Radix']  = {
    ...
    ['Subcombines'] = {
        ...
        ['Cake Round'] = {
            Recipe='Cake Round',
            Trivial=37,
            Materials={'Water Flask','Cake Round Mold','Metal Bits','Ceramic Lining'},
            Container='Forge',
            Tradeskill='Blacksmithing',
        },
        ['Winter Chocolate'] = {
        ...
        ['Dairy Spoon'] = {
            Recipe='Dairy Spoon',
            Trivial=74,
            Materials={'Water Flask','Scaler Mold','Metal Bits','Metal Bits'},
            Container='Forge',
            Tradeskill='Blacksmithing',
            Tool=true,
        },
        ...
        ['Ethereal Temper'] = {
            ...
            Trivial=212,
            Materials={'Celestial Essence','Celestial Essence','Soda','Emerald Tea Leaf'},
            Container='Brew Barrel',
            Tradeskill='Brewing',
        },
        ['Soda Water'] = {
    ...
    ['Materials'] = {
        ...
        ['Dark Brown Coal'] = {Location='Zosran Hammertail',SourceType='Vendor'},
        ['Plate Gauntlet Template Mold'] = {Location='Zosran Hammertail',SourceType='Vendor'},
        ['Indium Ore'] = {Location='Dropped',SourceType='Dropped'},
        ['Plate Gorget Template Mold'] = {Location='Zosran Hammertail',SourceType='Vendor'},
        ['Toluene Coal'] = {Location='Zosran Hammertail',SourceType='Vendor'},
        ['Cobalt Ore'] = {Location='Dropped',SourceType='Dropped'},
        ...
        -- Alchemy
        ['Birthwort'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Blue Vervain Bulb'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Fenugreek'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Valerian Root'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Duskglow Vine'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Violet Tri-Tube Sap'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Arnworth'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Katuka Bark'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Cententialspore'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Bistort'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Stinging Nettle'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ['Snakes Head Iris'] = {Location='Alchemist Redsa',SourceType='Vendor'},
        ...
        ['Nodding Blue Lily'] = {Location='Crypt of Decay',SourceType='Dropped'},
        ['White Hellebore'] = {Location='Various zones',SourceType='Dropped'},
        ['Autumn Crocus'] = {Location='DoN zones',SourceType='Dropped'},
        ['Red Cups'] = {Location='DoN zones',SourceType='Dropped'},
        -- Poison Making
        ['Cinnabar'] = {Location='Myre',SourceType='Vendor',Zone='kaladimb'},
        ['Gnomish Spirits'] = {Location='Tabben Bromal',SourceType='Vendor'},
        ['Lined Poison Vial'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Constrict Suspension'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Alocasia Root'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Sealed Poison Vial'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['King\'s Thorn'] = {Location='Ennixy Frennor',SourceType='Vendor',Zone='steamfont'},
        ['Ethereal Suspension'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Creeper Ivy'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Mt. Death Mineral Salts'] = {Location='Temple of Droga',SourceType='Dropped'},
        ['Thick Suspension Fluid'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Emulsifier'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Primitive Poison Vial'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Rough Poison Vial'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Plain Poison Vial'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Simple Poison Vial'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Smooth Poison Vial'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Etched Poison Vial'] = {Location='Loran Thu`Leth',SourceType='Vendor'},
        ['Weak Nigriventer Venom'] = {Location='Various zones',SourceType='Dropped'},
        ['Grade D Nigriventer Venom'] = {Location='Various zones',SourceType='Dropped'},
        ['Grade C Nigriventer Venom'] = {Location='Various zones',SourceType='Dropped'},
        ['Grade B Nigriventer Venom'] = {Location='Various zones',SourceType='Dropped'},
        ['Grade A Nigriventer Venom'] = {Location='Various zones',SourceType='Dropped'},
        ['Refined Grade A Nigriventer Venom'] = {Location='LDoN zones',SourceType='Dropped'},
        ['Weak Scorpion Venom'] = {Location='Various zones',SourceType='Dropped'},
        ['Grade C Scorpion Venom'] = {Location='Various zones',SourceType='Dropped'},
        ['Grade A Scorpion Venom'] = {Location='Various zones',SourceType='Dropped'},
        ['Mortar and Pestle'] = {Location='Loran Thu`Leth',SourceType='Vendor',Container=true},
        -- General
